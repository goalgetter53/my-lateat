...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'selectedCountry': PropertySchema(
      id: 5,
      name: r'selectedCountry',
      type: IsarType.string,
    ),
...
int _userEstimateSize(
  ...
  {
    final value = object.selectedCountry;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _userSerialize(
  ...
  writer.writeString(offsets[5], object.selectedCountry);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    selectedCountry: reader.readStringOrNull(offsets[5]),
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'selectedCountry',
      ));
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'selectedCountry',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'selectedCountry',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> selectedCountryIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'selectedCountry',
        value: '',
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortBySelectedCountry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'selectedCountry', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortBySelectedCountryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'selectedCountry', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenBySelectedCountry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'selectedCountry', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenBySelectedCountryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'selectedCountry', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctBySelectedCountry(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'selectedCountry',
          caseSensitive: caseSensitive);
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String?, QQueryOperations> selectedCountryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'selectedCountry');
    });
  }
